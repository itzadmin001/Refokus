...
function Product({ product, mover, count }) {
    return (
        <div className='w-full text-white md:py-20 p-5 md:h-[19rem] ' onMouseEnter={() => { mover(count) }}>
            <div className='max-w-screen-xl mx-auto flex item-center justify-between'>
